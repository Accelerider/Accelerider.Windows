...
namespace Accelerider.Windows.Infrastructure.TransferService
{
    internal class Program
    {
        public static async Task Main()
        {
            ...
            //        "https://accelerider-my.sharepoint.com/personal/cs02_onedrive_accelerider_com/_layouts/15/download.aspx?UniqueId=b8a04e28-cbe7-46b6-a7e9-ff1dc364539e&Translate=false&tempauth=eyJ0eXAiOiJKV1QiLCJhbGciOiJub25lIn0..SmtydjFmTm1vVXpxNlFiL0RGMy9oQlJxbzEzeklOMXVCamJZZitHaXp1TT0&ApiVersion=2.0",
            ...
            //ReadKey();
            //WriteLine("Start Download");
            //var taskConnect = taskObservable.Connect();

            //await TimeSpan.FromMilliseconds(5000);
            //WriteLine("disposable2 has been disposed. ");
            //disposable2.Dispose();

            //await TimeSpan.FromMilliseconds(5000);
            //WriteLine("taskConnect has been disposed. ");
            //taskConnect.Dispose();
